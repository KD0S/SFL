...
export default function TrapNight() {
    ...
    return (
        <main className="bg-trap w-screen overflow-scroll">
            ...
            <iframe className="rounded-2xl mx-auto m-20 shadow-lg shadow-[#EB00FF]" width="710" height="400" src="https://www.youtube.com/embed/-J6SdRomd_0?si=LwA_Nh36JCaXVyGl?autoplay=1&loop=1"></iframe>
        </main >
    )
}
